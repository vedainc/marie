...
| ~MX1~ (m)                | ~FORM~         | Expand a macro, a shorthand for CL:macroexpand-1. |
| ~MX~ (m)                 | ~FORM~         | Expand a macro, a shorthand for CL:macroexpand.   |
...
| ~READ-CAT~ (f)                | ~ARGS~            | Read from the concatenation of ARGS.                                              |
| ~PRIN1-DOWNCASE~ (f)          | ~SYMBOL~          | Return a downcased string from symbol.                                            |
| ~PRIN1-UPCASE~ (f)            | ~SYMBOL~          | Return a upcased string from symbol.                                              |
* Conditionals
...
| ~REPLACE-ALL~ (f)        | ~STRING~ ~REPLACEMENT~ | Return a new string in which all the occurences of PART in STRING is replaced with REPLACEMENT. |
* Strings
...
|-----------------------+------------------------------------------------------------|
| ~MAKE-PROJECT^MK~ (f) | Create a complete Lisp project skeleton including CLI app. |
